...
const carouselData = [
  ...
  `<h2 class="item-carousel--title">COMODIDAD</h2>
     <p class="item-carousel--description">Cursos de buceo totalmente personalizados de 1 a 4 alumnos como máximo. Nuestro objetivo es tu comodidad y que te sientas seguro y sin presiones. Siempre hay un instructor para vos.</p>`,
  /*`<h2 class="item-carousel--title">PROMOCION</h2>
